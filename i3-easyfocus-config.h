...
#define XCB_DEFAULT_FONT_NAME "-Misc-Fixed-*-*-*-*-*-200-*-*-*-*-*-*"

#define DARK_GREY {12079, 13364, 14906}
#define BLUE_GREY {19532, 30840, 39321}
#define RED {65535, 0, 0}
#define WHITE {65535, 65535, 65535}

#define COLOR_DEFAULT_URGENT_BG BLUE_GREY
#define COLOR_DEFAULT_URGENT_FG WHITE
#define COLOR_DEFAULT_FOCUSED_BG BLUE_GREY
#define COLOR_DEFAULT_FOCUSED_FG WHITE
#define COLOR_DEFAULT_UNFOCUSED_BG BLUE_GREY
#define COLOR_DEFAULT_UNFOCUSED_FG WHITE
